...
int main() {
    ...
    mhy_unity3d_file.open("H:\\MHY相关\\Star Rail\\Game\\WindowsBuild_Data\\StreamingAssets\\Asb\\Windows\\0c\\0c1bbd6b43f3e0a166e6cd33272491d7.unity3d", ios::in | ios::binary);
    ...
    mhy_unity3d_file.seekg(5, ios::beg);
    ...
    cout << "compressedBlocksInfoSize: " << compressedBlocksInfoSize_unsigned_int << endl;
    cout << "uncompressedBlocksInfoSize: " << uncompressedBlocksInfoSize_unsigned_int << endl;
    ...
    */
    ...
    fstream testoutput;
    testoutput.open("E:\\test.bin", std::ios::binary | std::ios::out);
